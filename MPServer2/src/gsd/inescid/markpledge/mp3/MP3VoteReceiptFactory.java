...
public class MP3VoteReceiptFactory extends MPAbstractVoteReceiptFactory {
	...
	public MP3VoteReceiptFactory(IMPParameters param) {
		super(MarkPledgeType.MP3, param);
		//this.param = param;
	}
	...
	public IMPValidityProof getValidityProof() {
		try{
			...
			for(int i=0; i<this.numberOfCandidates; i++)
			{
				...
				proof = new CGS97BallotValidity(yesVote, vEnc, kpub, m, this.randomSource, this.md);

...
public class CGS97BallotValidity {
	...
	public CGS97BallotValidity(Boolean ballotType, ElGamalVerifiableEncryption ballotEncryption, 
			ElGamalPublicKey kpub, BigInteger m, Random random, MessageDigest md123) throws NoSuchAlgorithmException
			{
		if(random == null);
		...
		String hashFunction = DEFAULT_HASH_FUNCTION;

		//ON THE SERVER DID NOT WORK WITH THE RECEIPT PARAMETER (too much /dev/random connections!?)

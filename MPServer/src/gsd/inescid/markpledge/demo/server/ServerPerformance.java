...
public class ServerPerformance implements Runnable{
	...
	static int numberOfVotes = 10;
	static int numberOfCandidates = 5;
	static MarkPledgeType ballotType = MarkPledgeType.MP1A;
	...
	public IMPVoteAndReceipt[] createVotesAndReceipt(
			...
			IMPParameters param, Random randomSource, boolean withValidity)
		{
			...
			for(int i=0; i<numberOfVotes; i++)
			{
				...
				IMPReceipt receipt = factory.getReceipt(randomSource.nextInt(this.numberOfCandidates),
						chal);
				...
				IMPParameters param, MessageDigest md)
		{
			...
			long sCGS97andVoteSum, sReceipt, sCanonical, eCGS97andVoteSum, eReceipt, eCanonical;
			long tCGS97andVoteSum=0, tReceipt=0, tCanonical=0;
